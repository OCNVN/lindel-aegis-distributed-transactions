 ...
 * @author carloslucero
 */
public class AlmacenarPostgres extends AbstractDistributedTransactionExecutable{
    private final static Logger log = Logger.getLogger(AlmacenarPostgres.class);
    ...
    public byte[] execute(byte[] data) {
        ...
        try {
            ...
            dataJson.put("prueba", valorPrueba + "->almacenar postgres");
