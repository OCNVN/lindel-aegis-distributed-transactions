 ...
 * @author carloslucero
 */
public class DistributedTransactionsBuilder {
    private final static Logger log = Logger.getLogger(DistributedTransactionsBuilder.class);
    ...
    protected ArrayList<DistributedTransaction> distributedTransactions;
     ...
     */
    public DistributedTransactionsBuilder(String filename) throws JDOMException, IOException{
     ...
     */
    public DistributedTransactionsBuilder(File confFile) throws JDOMException, IOException{
        dtcDictionary = new Hashtable<>();
    ...
    private void run(){
        ...
        for(DistributedTransactionConfiguration dtc : distributedTransactionsConfigurations){
            DistributedTransaction dt = new DistributedTransaction(dtc);
            dt.runMasters();
            dt.runWorkers();
        ...
        for(Element transaccionDistribuida : applicationNode.getChildren("distributed-transaction")){
            ...
            if(workersScheduleNode != null){
                ...
                for (int i = 0; i < workerScheduleElements.size(); i++) {
                    ...
                    WorkerScheduleConfiguration ws = new WorkerScheduleConfiguration(name, scheduleOrder, parallelism, implementationClassName, idOffset);
    ...
    public class WorkerScheduleConfiguration {
        ...
        public WorkerScheduleConfiguration(String name, int sheduleOrder, int parallelism, String implementationClassName, int idOffset) {
            this.name = name;
